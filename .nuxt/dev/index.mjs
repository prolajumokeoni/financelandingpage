...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/nitropack/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/source-map/source-map.js';
import { defineDiagnostics, createConsoleReporter } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/nostics/dist/formatters/ansi.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/devalue/index.js';
import { getContext as getContext$1 } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/errx/dist/index.mjs';
import { isVNode, isRef, toValue } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/pathe/dist/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/unhead/dist/server.mjs';
import { walkResolver } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/unhead/dist/utils.mjs';
import { DeprecationsPlugin } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/oniolajumoke/Documents/fin/finapp/financelandingpage/node_modules/unhead/dist/plugins.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/oniolajumoke/Documents/fin/finapp/financelandingpage/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/oniolajumoke/Documents/fin/finapp/financelandingpage","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/oniolajumoke/Documents/fin/finapp/financelandingpage/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/oniolajumoke/Documents/fin/finapp/financelandingpage/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/oniolajumoke/Documents/fin/finapp/financelandingpage/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/oniolajumoke/Documents/fin/finapp/financelandingpage/.data/kv"}));
...
const _JsbZTPGF6qEpPTqGDC2VmzvhjBONgcSSAjpDL1fs4ow = (function(nitro) {
...
const rootDir = "/Users/oniolajumoke/Documents/fin/finapp/financelandingpage";
...
const plugins = [
  _JsbZTPGF6qEpPTqGDC2VmzvhjBONgcSSAjpDL1fs4ow,
...
const _WQ67vS = eventHandler((event) => {
...
const _lazy_Jr5ycf = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _WQ67vS, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_Jr5ycf, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Jr5ycf, lazy: true, middleware: false, method: undefined }
];
